/**
 * Loki Aspnetcore - loki service initializer
 * 
 * On the node/loki side of this project we are going
 * to split out the implementation specific initializer
 * from a general purpose loki nodejs interface.
 * 
 * This initializer will handle constructing the loki database
 * with its specific constructor options, as well as initializing
 * it with collections, views, transforms, and data.
 */
 ...
 * 
 * @param {callback} callback accepting loki db instance
 */
